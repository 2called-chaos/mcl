module Mcl
  class Aliases < Handler
    ...
    def setup_parsers
      ...
      # water breathing
      register_command("breath") {|h, p, c, t, o| h.effect(t, "wather_breathing", 6000, 255) }
      ...
      # misc
      register_command("hearts") {|h, p, c, t, o| h.effect(t, "absorption", 60, 255) }
      ...
      register_command("uwater") do |h, p, c, t, o|
        h.effect(t, "wather_breathing", 6000, 255)
        h.effect(t, "night_vision", 6000, 255)
        ...
        h.ritem(t, "armor.leggings", "diamond_leggings 1 0 {ench:[{id:0,lvl:1337},{id:7,lvl:1337}],Unbreakable:1}")
        h.ritem(t, "armor.boots", "diamond_boots 1 0 {ench:[{id:0,lvl:1337},{id:7,lvl:1337},{id:8,lvl:3}],Unbreakable:1}")
      end
    end
