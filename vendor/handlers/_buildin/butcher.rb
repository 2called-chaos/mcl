    ...
    def register_butcher
      register_command :butcher, desc: "Kill certain groups of entities (more info with !butcher help)", acl: :builder do |player, args|
        ...
        when "pr", "projectile", "projectiles"
          ...
          tellm(player, {text: "p/players [rad]", color: "gold"}, {text: " kills players"})
          tellm(player, {text: "h/hostile [rad]", color: "gold"}, {text: " kills hostile mobs"})
          tellm(player, {text: "b/bats [rad]", color: "gold"}, {text: " kills bats"})
          tellm(player, {text: "m/mobs [rad]", color: "gold"}, {text: " kills passive but no farm mobs"})
          tellm(player, {text: "an/animals [rad]", color: "gold"}, {text: " kills animals"})
          tellm(player, {text: "as/armor_stands [rad]", color: "gold"}, {text: " kills armor stands"})
          tellm(player, {text: "aec/area_effect_cloud [rad]", color: "gold"}, {text: " kills effect clouds"})
          tellm(player, {text: "b/boats [rad]", color: "gold"}, {text: " kills boats"})
          tellm(player, {text: "mi/minecart [rad]", color: "gold"}, {text: " kills all kinds of minecarts"})
          tellm(player, {text: "i/items [rad]", color: "gold"}, {text: " kills dropped items"})
          tellm(player, {text: "x/xp [rad]", color: "gold"}, {text: " kills XP orbs"})
          tellm(player, {text: "t/tnt [rad]", color: "gold"}, {text: " kills primed TNT (no carts!)"})
          tellm(player, {text: "v/villagers [rad]", color: "gold"}, {text: " kills villagers"})
          tellm(player, {text: "a/arrows [rad]", color: "gold"}, {text: " kills arrows"})
          tellm(player, {text: "p/projectiles [rad]", color: "gold"}, {text: " kills all projectiles"})
        end
